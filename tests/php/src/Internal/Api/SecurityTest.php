...
class SecurityTest extends WC_REST_Unit_Test_Case {
	...
	public function test_rest_route_uses_return_true_permission_callback(): void {
		$registrar = new GraphQLEndpointRegistrar( DummyGraphQLController::class, 'wc-test', '/security-route', array( 'POST' ) );

		$registrar->handle_rest_api_init();

		$routes = rest_get_server()->get_routes();
		$this->assertArrayHasKey( '/wc-test/security-route', $routes );
		$this->assertSame( '__return_true', $routes['/wc-test/security-route'][0]['permission_callback'] );
	}
}
