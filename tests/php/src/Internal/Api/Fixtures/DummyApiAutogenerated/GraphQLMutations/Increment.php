...
class Increment {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Increment a value by an optional amount', 'woocommerce-dual-api' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'value' => array(
					...
					'description' => __( 'The starting value', 'woocommerce-dual-api' ),
				),
				'by'    => array(
					'type'         => Type::nonNull( Type::int() ),
					'description'  => __( 'How much to add', 'woocommerce-dual-api' ),
					'defaultValue' => 1,
				),
			),
