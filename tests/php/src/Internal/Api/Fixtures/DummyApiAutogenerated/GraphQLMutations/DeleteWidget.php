...
class DeleteWidget {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Delete a widget', 'woocommerce-dual-api' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'id'    => array(
					...
					'description' => __( 'The widget id to delete', 'woocommerce-dual-api' ),
				),
				'force' => array(
					'type'         => Type::nonNull( Type::boolean() ),
					'description'  => __( 'When true, ignore \"not found\" errors', 'woocommerce-dual-api' ),
					'defaultValue' => false,
				),
			),
