...
class CreateWidget {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Create a new widget', 'woocommerce-dual-api' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'input'          => array(
					...
					'description' => __( 'The data for the new widget', 'woocommerce-dual-api' ),
				),
				'related_inputs' => array(
					'type'         => Type::listOf( Type::nonNull( CreateWidgetInput::get() ) ),
					'description'  => __( 'Related widget inputs for array input generation coverage', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
			),
