...
class ListWidgets {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'List widgets with cursor-based pagination', 'woocommerce-dual-api' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'first'        => array(
					'type'         => Type::int(),
					'description'  => __( 'Return the first N results. Must be between 0 and 100.', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
				'last'         => array(
					'type'         => Type::int(),
					'description'  => __( 'Return the last N results. Must be between 0 and 100.', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
				'after'        => array(
					'type'         => Type::string(),
					'description'  => __( 'Return results after this cursor.', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
				'before'       => array(
					'type'         => Type::string(),
					'description'  => __( 'Return results before this cursor.', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
				'search'       => array(
					'type'         => Type::string(),
					'description'  => __( 'A free-text search term', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
				'color'        => array(
					'type'         => ColorType::get(),
					'description'  => __( 'Filter widgets by color', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
				'min_priority' => array(
					'type'         => PriorityType::get(),
					'description'  => __( 'A second filter applied after the unrolled ones', 'woocommerce-dual-api' ),
					'defaultValue' => null,
				),
			),
