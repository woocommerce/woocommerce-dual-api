...
class AuthorizeThrowsQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description' => __( 'authorize() throws to verify exception translation', 'woocommerce-dual-api' ),
			'args'        => array(
				'kind' => array(
					'type'        => Type::nonNull( Type::string() ),
					'description' => __( 'Which exception class authorize() should raise.', 'woocommerce-dual-api' ),
				),
			),
