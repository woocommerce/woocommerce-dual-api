...
class GetIdentifiable {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Return either a Widget or a Gadget, both of which implement Named', 'woocommerce-dual-api' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'kind' => array(
					...
					'description' => __( 'Which kind of object to return', 'woocommerce-dual-api' ),
				),
			),
