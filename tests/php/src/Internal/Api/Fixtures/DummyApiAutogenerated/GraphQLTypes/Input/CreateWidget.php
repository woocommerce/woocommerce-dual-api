		...
		if ( null === self::$instance ) {
			self::$instance = new InputObjectType(
				array(
					...
					'description' => __( 'Data needed to create a new widget', 'woocommerce-dual-api' ),
					'fields'      => fn() => array(
						'label'      => array(
							'type'        => Type::nonNull( Type::string() ),
							'description' => __( 'The widget label', 'woocommerce-dual-api' ),
						),
						'weight'     => array(
							'type'        => Type::int(),
							'description' => __( 'Optional weight in grams', 'woocommerce-dual-api' ),
						),
						'color'      => array(
						...
						'tag_ids'    => array(
							...
							'description' => __( 'Tag IDs to attach to the widget', 'woocommerce-dual-api' ),
						),
						'expires_at' => array(
							'type'        => DummyDateTimeType::get(),
							'description' => __( 'When the widget should expire', 'woocommerce-dual-api' ),
						),
					),
				)
			);
