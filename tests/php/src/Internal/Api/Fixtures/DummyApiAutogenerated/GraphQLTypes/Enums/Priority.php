	...
	public static function get(): EnumType {
		if ( null === self::$instance ) {
			self::$instance = new EnumType(
				array(
					'name'        => 'TaskPriority',
					'description' => __( 'Priority level for a task', 'woocommerce-dual-api' ),
					'values'      => array(
						'LOW'             => array(
							'value'       => PriorityEnum::Low,
							'description' => __( 'Low priority', 'woocommerce-dual-api' ),
						),
						...
						'HIGH'            => array(
							...
							'description'       => __( 'High priority', 'woocommerce-dual-api' ),
