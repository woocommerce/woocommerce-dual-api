		...
		if ( null === self::$instance ) {
			self::$instance = new ObjectType(
				array(
					...
					'description' => __( 'The result of a generic operation', 'woocommerce-dual-api' ),
					'fields'      => fn() => array(
						'success' => array(
							'type'        => Type::nonNull( Type::boolean() ),
							'description' => __( 'Whether the operation succeeded', 'woocommerce-dual-api' ),
						),
						'message' => array(
							'type'        => Type::nonNull( Type::string() ),
							'description' => __( 'A human-readable status message', 'woocommerce-dual-api' ),
						),
					),
				)
			);
