...
class AttributesTest extends AutogeneratedTestCase {
	...
	public function test_deprecated_on_enum_case_sets_deprecation_reason(): void {
		...
		$this->assertSame( 'Use NORMAL_PRIORITY instead.', $value->deprecationReason ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase -- engine property name.
	...
	public function test_deprecated_on_property_sets_deprecation_reason(): void {
		...
		$this->assertSame( 'Use price instead.', $field->deprecationReason ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase -- engine property name.
