...
class PrincipalParamTest extends AutogeneratedTestCase {
	...
	public function test_resolver_source_wires_principal_from_context(): void {
		$source = (string) file_get_contents( __DIR__ . '/../Fixtures/DummyApiAutogenerated/GraphQLQueries/PrincipalAwareQuery.php' ); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_get_contents_file_get_contents -- local fixture file.
