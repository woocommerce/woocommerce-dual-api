...
class StalenessChecker {
	 ...
	 *
	 * @param string $api_dir           Absolute path to the code-API sources.
	 * @param string $autogenerated_dir Absolute path to the autogenerated output directory.
	 */
	public static function is_stale( string $api_dir, string $autogenerated_dir ): bool {
		...
		return self::compute_source_hash( $api_dir ) !== $stored_hash;
	}
